        ...
        if(this.props.action === "logFood"){
            ...
            actionButtons =  <div className="modal-footer full-width " style={{clear:"both"}} onClick={this.sendFoodToParent.bind(this)}>
                                <div  className="col-xs-6 mx-0 px-0 ">
                                    <a id="deleteLoggedFood" className="btn c-white bg-c-red-danger full-width mb-0">Delete</a>
                                </div>
                                <div className="col-xs-6 mx-0 px-0 ">
                                    <a  id="updateLoggedFood" className="btn c-white bg-c-green-success full-width mb-0" style={{borderLeft:"1px solid white"}}>Update</a>
                                </div>
                            </div>;
        }
        else {
